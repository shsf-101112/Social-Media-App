...
SECRET_KEY = 'django-insecure-2akf_p8r)!$&m#l_7l06j%y2&%xv#^e6sl=yu+kgt_)=59#)6j'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.suggestions_processor',
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # This should be the folder where your CSS is
]
